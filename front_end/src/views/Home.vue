    ...
    <v-container class="md" fluid>
      <v-row justify-center>
        ...
        <div style="flex-grow: 100; text-align: center; padding-top:7px">
          ...
          <span id="writing" v-if="isLoggedIn && selectedNoteInfo != {} && selectedNoteInfo.occupiedNo != 0 && selectedNoteInfo.occupiedNo != $store.state.userInfo.no">{{ selectedNoteInfo.occupiedName }}님 작성중...</span>
