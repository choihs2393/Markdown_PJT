        ...
        <v-card class="elevation-12">
          ...
          <v-card-text>
            <v-form class="ma-4">
                  ...
                  >
                    <template v-slot:append-outer>
                      <v-btn
                        ...
                        rounded
                        @click="
                          checkEmailDuplicate(signupData),
              ...
              <v-alert
                ...
                outlined
                type="error"
                v-if="isDuplicateAlert && !isDuplicateChecked"
              >
                이미 가입된 Email 입니다.
              </v-alert>

              <ValidationProvider
                v-show="isDuplicateChecked"
                mode="eager"
                v-slot="{ errors }"
                name="CodeNumber"
                rules="required"
                ...
                >
                  <template v-slot:append-outer>
                    <v-btn
                      ...
                      rounded
                      class="mr-1"
                      @click="checkAuthNum(signupData), (isAuthNumAlert = true)"
                      >Confirm</v-btn
                    >
                    <v-btn
                      outlined
              ...
              <v-alert
                ...
                outlined
                type="success"
                v-if="isAuthNumAlert && isAuthNumChecked"
              >
                인증코드가 확인되었습니다.
              </v-alert>
              <v-alert
          ...
          <v-card-actions>
            ...
            <v-btn
              class="mb-4 mr-1"
              color="primary"
              @click="signup(signupData), submit()"
              :disabled="invalid || !isDuplicateChecked || !isAuthNumChecked"
              >SignUp</v-btn
            >
...
export default {
  ...
  computed: {
    ...mapState(["isDuplicateChecked", "isAuthNumChecked"])
  },
